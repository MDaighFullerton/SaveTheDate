...
@Component({
  ...
  providers: [
    {
      provide: 'emailProvider', useValue: 'sdsdsdsds'
    }
]
})
export class EventInfoComponent implements OnInit {
  ...
  public get email() { return this.eventInfoForm.get('email'); }
  public get firstName() { return this.eventInfoForm.get('firstName'); }
  public get lastName() { return this.eventInfoForm.get('lastName'); }
